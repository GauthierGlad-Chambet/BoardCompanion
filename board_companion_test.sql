...
--
-- Base de données : `board_companion_test`
--
CREATE DATABASE IF NOT EXISTS `board_companion_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `board_companion_test`;
...
CREATE TABLE IF NOT EXISTS `project` (
  ...
  `nb_predec` int NOT NULL DEFAULT '1',
  `is_alone` tinyint(1) NOT NULL DEFAULT '0',
  `is_cleaning` tinyint(1) NOT NULL DEFAULT '0',
  `is_detailed` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `avg_duration_estimated_per_pages` float NOT NULL DEFAULT '0',
