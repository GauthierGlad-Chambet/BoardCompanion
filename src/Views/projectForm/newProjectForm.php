                ...
                <form class="container" id="newProject-form" action="" method="POST" enctype="multipart/form-data">
                        <div>
                                <div>
                                        ...
                                        <input <?php if (!empty($_SESSION['error']['name'])) { ?> class="inputError" <?php } ?> type="text" name="name" id="name" autocomplete="off" value="<?= $name ?? '' ?>" required>
                                ...
                                <div>
                                        ...
                                        <?php }
                                        unset($_SESSION['error']['episode_nb']); ?>
                                ...
                                <div>
                                        ...
                                        <?php }
                                        unset($_SESSION['error']['episode_title']); ?>
                                </div>
                                <div>
                                        ...
                                        <?php }
                                        unset($_SESSION['error']['nb_predec']); ?>
                                </div>
                                ...
                                <div class="block-radio">
                                        ...
                                        <?php }
                                        unset($_SESSION['error']['is_cleaning']); ?>
                                </div>
                        </div>
                        <div>
                                ...
                                <div class="block-dates">
                                        ...
                                        <?php }
                                        unset($_SESSION['error']['date_begin']); ?>
                                ...
                                <div class="block-radio">
                                        ...
                                        <?php }
                                        unset($_SESSION['error']['script_detailed']); ?>
                                </div>
                                <div>
