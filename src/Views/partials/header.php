...
<body class="<?= $pageClass ?? '' ?>">
    <header>
        <nav>
            ...
            <a class="icones-menu" href="/nouveau-projet">
            ...
            <a class="icones-menu" href="/tableau-de-bord">
            ...
            <!-- <a class="icones-menu" href="/planning">
            ...
            <a class="icones-menu" href="/arborescence">
            ...
            <a class="icones-menu" href="/compte">
            ...
            <a class="icones-menu" name="logout" href="/deconnexion">
