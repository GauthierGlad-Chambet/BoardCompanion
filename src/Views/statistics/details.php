<main id="page-details">
    <div class="page-container container-details">
        ...
        <div class="button-lot">
            <a class="button" href="/modifier-projet?project_id=<?= $project->getId() ?>">Modifier les informations</a>
            <?php if (!$finalReport) { ?>
                <a class="button" href="/bilan-final?project_id=<?= $project->getId() ?>">Bilan final</a>
        </div>
    <?php } else { ?>
        <a class="button" href="/modifier-bilan-final?project_id=<?= $project->getId() ?>">Modifier le bilan final</a>
    </div>
...
<div class="popup popupSuppr container" id="popupProjet">
    ...
    <div>
        ...
        <form method="POST" action="/supprimer-projet">
