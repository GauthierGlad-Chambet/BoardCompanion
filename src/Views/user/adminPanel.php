        ...
        <table>
            ...
            <tbody>
                <?php foreach ($allUsers as $user): ?>
                    <form method="POST" action="/admin-supprimer-compte">
        ...
        <table>
            ...
            <tbody>
                <?php foreach ($allProjectsAllUsers as $project): ?>
                    <form method="POST" action="/admin-supprimer-projet">
