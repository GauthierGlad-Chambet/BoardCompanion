...
class UserModel extends MotherModel
{
    ...
    {
        $query = "SELECT id, pseudo, email, avg_pages_per_day, avg_cleaning_duration, avg_shots_per_page, role FROM user";
    ...
    function findByMail(string $email)
    {
        ...
        $query =
            "SELECT id, pseudo, email, role FROM user
            WHERE email=:email";
    ...
    function findById(string $id)
    {
        ...
        // Requête préparée pour récupérer les informations de l'utilisateur
        $query = "
            SELECT user.id, pseudo, email, avg_pages_per_day, avg_cleaning_duration, avg_shots_per_page, role, user.fk_appreciation, appreciation.label as appreciation_label
            FROM user
