        ...
        <div class="container block-login" id="block-connection">
            <form action="" method="POST">
                <div>
                    ...
                    <?php }
                    unset($_SESSION['error']['sigin-email']); ?>
                </div>
                <div>
        ...
        <div class="container block-login" id="block-inscription">
            <form action="" method="POST">
                <div>
                    ...
                    <?php }
                    unset($_SESSION['error']['emailExists']); ?>
                </div>
                <div>
                ...
                <div>
                    ...
                    <?php }
                    unset($_SESSION['error']['accepteCGU']); ?>
                </div>
