...
<form action="" method="POST">
    ...
    <?php foreach ($sequences as $index => $sequence): ?>
        ...
        <input type="hidden" name="sequence_header_<?= $index ?>" value="<?= htmlspecialchars($sequence->getTitle()) ?>">
        <input type="hidden" name="sequence_content_<?= $index ?>" value="<?= htmlspecialchars($sequence->getScript()) ?>">
