...
<body class="<?= $pageClass ?? '' ?>">
    <header>
        <nav>
            <a class="icones-menu" href="/BoardCompanion/home">
            ...
            <a class="icones-menu" href="/BoardCompanion/nouveau-projet">
            ...
            <a class="icones-menu" href="/BoardCompanion/tableau-de-bord">
            ...
            <!-- <a class="icones-menu" href="/BoardCompanion/planning">
            ...
            <a class="icones-menu" href="/BoardCompanion/arborescence">
            ...
            <a class="icones-menu" href="/BoardCompanion/compte">
            ...
            <a class="icones-menu" name="logout" href="/BoardCompanion/deconnexion">
